package com.yeahwell.scala.grammer.demomatch
...
// 案例：成绩评价（升级版）
def judgeGrade02(name: String, grade: String) {
  grade match {
...
// 案例：成绩评价（升级版）
def judgeGrade03(name: String, grade: String) {
  grade match {
    case "A" => println(name + ", you are excellent")
    case "B" => println(name + ", you are good")
    case "C" => println(name + ", you are just so so")
